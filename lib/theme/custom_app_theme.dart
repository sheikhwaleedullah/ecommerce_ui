...
class AppThemes {
 ...
 static const TextStyle homeProducModel = TextStyle(
  color: AppConstantsColor.lightTextColor,
    fontWeight: FontWeight.bold,
    fontSize: 22,
...
/// Details
 static const TextStyle detailAppBar = TextStyle(
  color: AppConstantsColor.lightTextColor,
    fontWeight: FontWeight.w600,
    fontSize: 22,
 );
  static const TextStyle detailMoreText = TextStyle(
  fontWeight: FontWeight.w500,
 ...
 static TextStyle detailProductDescriptions = 
